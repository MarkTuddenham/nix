---
description: Perform a ruthless, multi-perspective code review of git HEAD against develop.
...
Perform a ruthless, brutal, in-depth, extremely critical code review of the most recent git commit (HEAD).
...
Get the full commit message and diff. Read every line carefully.
