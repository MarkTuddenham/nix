...
vim.api.nvim_create_autocmd("FileType", {
	pattern = { "tex", "plaintex", "plaintext", "gitcommit", "markdown" },
	callback = function()
...
-- On macOS use pbcopy/pbpaste directly — avoids encoding issues when inside tmux
